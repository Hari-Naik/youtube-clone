...
import { setLikedVideos } from "../../app/features/likedVideosSlice";
...
const VideoDetails = (): JSX.Element => {
  ...
  const onClickLike = () => {
    console.log("liked");
    dispatch(setLikedVideos(videoDetails));
  };
            ...
            <>
                      ...
                      <div className="likes_dislikes">
                        <button type="button" onClick={onClickLike}>
                          ...
                          <span className="margin">
                            {abbreviateNumber(videoDetails?.stats?.likes)}
                          </span>
                        </button>
              ...
              <div className="video_description">
                <div className="video_description_stats">
                  ...
                  <span>
                    {getPublishedTimeText(videoDetails?.date?.published)}
                  </span>
                </div>
                <span>
                  {showmore
